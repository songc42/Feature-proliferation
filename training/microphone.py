...
def modify_micro(x,block_num,conv_0_1,dataset):
    ...
    layer_all_top_dataset=layer_all_top[load_variavle('dataset.txt')]
    layer='b'+str(block_num)+'_conv'+str(conv_0_1)
    top_dex=layer_all_top_dataset[layer]
    modify_num=8
    for i in range(modify_num):
        x[0][top_dex[i]] = x[0][top_dex[i]] * 3
...
#         minus_threshold = [0.1, 0.1, 0.1, 0.1, 0.67]
...
#         minus_threshold = [0, 0.1, 0.1, 0.3, 0.67]
